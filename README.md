...
- [Abstract classes](#the-abstract-classes)
    - [AbstractEnumBase](#abstractenumbase)
...
**If you do not want to implement this method, you can too create your own class that inherits from our [AbstractEnumBase](#abstractenumbase) class.**
...
### AbstractEnumBase
#### Description
This class is the base class for any ```EnumType``` class generated by [PackageGenerator](https://github.com/WsdlToPhp/PackageGenerator). It implements our [EnumInterface](#enuminterface) interface.
