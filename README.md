...
## The interfaces
The defined interfaces must be used in order to be able to match the requirements for the generated classes by the [PackageGenerator](https://github.com/WsdlToPhp/PackageGenerator).
...
#### Description
This class is the base class for any ```ArrayType``` class generated by [PackageGenerator](https://github.com/WsdlToPhp/PackageGenerator). It implements our [StructArrayInteface](#structarrayinteface) interface.
